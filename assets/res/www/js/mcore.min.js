...
/*! MPrevention Plugin 2.1.0.1 [Android 2.1.0.1, iOS 2.1.0.1] */
(function(b,c){var a="2.1.0.1";M.plugin("prevention",{rooting:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{callback:c},surrogateKeys:{check:"callback",oncheck:"callback"},enumsKeys:{}});g=e.convert(arguments);d=M.execute("wn2PluginPreventionRooting");if(typeof g.callback==="function"){g.callback.call(f,d,g);return M}return d},fraud:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["finish"],defaultSetting:{rooting:true,indicator:true,callback:function(i,j){M.debug.log("M.prevention.fraud.finish",i,j)}},surrogateKeys:{jailbreak:"rooting",oncheck:"callback",check:"callback",onfinish:"callback",finish:"callback"},enumsKeys:{}});g=e.convert(arguments);g.response=M.response.on(function(i){g.callback.call(f,i,g)});h.rooting=g.rooting===true?"Y":"N";h.indicator=g.indicator===true?"Y":"N";h.callback=g.response.toString();d=M.execute("wn2PluginPreventionFraud",h);if(d.status!=="PROCESSING"){g.response.execute(d)}return M}},a)})(window);

/*! M3rdPartyFingerprintBasic android plugin 2.1.0.4 [Android 2.1.0.4] */
(function(b,c){var a="2.1.0.4";M.plugin("3rd_fingerprint_basic",{auth:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{dialog:true,progress:function(k,j){},callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.progressResponse=M.response.on(function(j){var l,k;k=j.status;l=JSON.parse(j.result);h.progress.call(f,k,l,h)});h.progressResponse.progressing=true;h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=JSON.parse(j.result)}h.progressResponse.expire();h.callback.call(f,k,l,h)});i.dialog=h.dialog==true?"Y":"N";i.progress=h.progressResponse.toString();i.callback=h.response.toString();d=M.execute("3rd.fingerprint.basic.wn2Auth",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},check:function(h){var e,i,d,g=b,k={};if(h===c){d=M.execute("3rd.fingerprint.basic.wn2Check");return d}e=M.defaultSetting.create({defaultSetting:{callback:function(m,l){}},surrogateKeys:{},enumsKeys:{}});d=M.execute("3rd.fingerprint.basic.wn2Check");i=e.convert(h);if(typeof i.callback==="function"){var j,f;if(typeof(d.result)=="string"){d.result=JSON.parse(d.result)}f=d.status;j=d.result;i.callback.call(g,f,j,i);return M}return d},moveSetting:function(g){var e,h,d,f=b,i={};d=M.execute("3rd.fingerprint.basic.wn2MoveSetting");return d}},a)})(window);

/*! M3rdPartyPatternBasic android plugin 2.1.0.2 [android 2.1.0.2] */
(function(b,c){var a="2.1.0.2";M.plugin("3rd_pattern_basic",{lock:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{type:"",callback:function(k,j){},customConfirmPage:"",customSetPage:""},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=JSON.parse(j.result)}h.callback.call(f,k,l,h)});i.callback=h.response.toString();i.type=h.type;i.customConfirmPage=h.customConfirmPage;i.customSetPage=h.customSetPage;d=M.execute("3rd.pattern.basic.wn2PatternLock",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},clear:function(g){var e,h,d,f=b,i={};d=M.execute("3rd.pattern.basic.wn2Remove");return d}},a)})(window);

/*! M3rdPartyPinBasic android plugin 2.1.0.2 [Android 2.1.0.2] */
(function(b,c){var a="2.1.0.2";M.plugin("3rd_pin_basic",{register:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{length:0,callback:function(k,j){},page:""},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=JSON.parse(j.result)}h.callback.call(f,k,l,h)});i.callback=h.response.toString();i.length=h.length;i.page=h.page;d=M.execute("3rd.pin.basic.wn2Register",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},remove:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=JSON.parse(j.result)}h.callback.call(f,k,l,h)});i.callback=h.response.toString();d=M.execute("3rd.pin.basic.wn2Remove",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},get:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=JSON.parse(j.result)}h.callback.call(f,k,l,h)});i.callback=h.response.toString();d=M.execute("3rd.pin.basic.wn2Get",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},auth:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{length:4,callback:function(k,j){},page:""},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=JSON.parse(j.result)}h.callback.call(f,k,l,h)});i.callback=h.response.toString();i.length=h.length;i.page=h.page;d=M.execute("3rd.pin.basic.wn2Auth",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d}},a)})(window);

/*! M3rdPartyFingerprintBasic iOS plugin 2.1.0.1 [iOS 2.1.0.1] */
(function(b,c){var a="2.1.0.1";M.plugin("3rd_iOS_fingerprint_basic",{auth:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=j.result}h.callback.call(f,k,l,h)});i.callback=h.response.toString();d=M.execute("wn2Auth",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},check:function(h){var e,i,d,g=b,k={};if(h===c){d=M.execute("wn2Check");return d}e=M.defaultSetting.create({defaultSetting:{callback:function(m,l){}},surrogateKeys:{},enumsKeys:{}});i=e.convert(h);d=M.execute("wn2Check");if(typeof i.callback==="function"){var j,f;if(d.status=="FAIL"){f=d.status;j=d.message}else{f=d.status;j=d.result}i.callback.call(g,f,j,i);return M}return d},moveSetting:function(g){var e,h,d,f=b,i={};d=M.execute("wn2MoveSetting");return d}},a)})(window);

/*! M3rdPartyPattern iOS plugin 2.1.0.1 [iOS 2.1.0.1] */
(function(b,c){var a="2.1.0.1";M.plugin("3rd_iOS_pattern_basic",{lock:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{type:"",callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=j.result}h.callback.call(f,k,l,h)});i.callback=h.response.toString();i.type=h.type;d=M.execute("wn2PatternLock",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d}},a)})(window);

/*! M3rdPartyPinBasic iOS plugin 2.1.0.1 [Android 2.1.0.1] */
(function(b,c){var a="2.1.0.1";M.plugin("3rd_iOS_pin_basic",{register:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{param:{},callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=j.result}h.callback.call(f,k,l,h)});i.callback=h.response.toString();i.param=h.param;d=M.execute("wn2ThirdPartyPinRegister",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},remove:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=j.result}h.callback.call(f,k,l,h)});i.callback=h.response.toString();d=M.execute("wn2ThirdPartyPinRemove",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},get:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=j.result}h.callback.call(f,k,l,h)});i.callback=h.response.toString();d=M.execute("wn2ThirdPartyPinGetPin",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d},auth:function(g){var e,h,d,f=b,i={};e=M.defaultSetting.create({defaultSetting:{param:{},callback:function(k,j){}},surrogateKeys:{},enumsKeys:{}});h=e.convert(g);h.response=M.response.on(function(j){var l,k;if(j.status=="FAIL"){k=j.status;l=j.message}else{k=j.status;l=j.result}h.callback.call(f,k,l,h)});i.callback=h.response.toString();i.param=h.param;d=M.execute("wn2ThirdPartyPinAuth",i);if(d.status!=="PROCESSING"){h.response.execute(d)}return d}},a)})(window);
